...
{
    public partial class ReplacementNoInvLines : System.Web.UI.UserControl
    {
        public List<StatisticsSalesLine> NoInvReplacementList { get; set; }
        ...
        public void PopulateData()
        {
            try
            {
                ...
                foreach (StatisticsSalesLine line in NoInvReplacementList)
                {
                    lineCount++;
                    ...
                    tblReplacementNoInv.Rows.Add(tr);
                }
                ...
                tblReplacementNoInv.Rows.Add(breakRow);
            }
            catch (Exception ex)
            {
