    ...
    <form id="frmUserControl" runat="server">       
        <asp:Table ID="TblUserControl" runat="server" Height="100%" Width="100%" HorizontalAlign="Center">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell ID="tcCreateRMA" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxCreateRMA" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcCreateReturnLabel" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxCreateReturnLabel" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcCreateExchangeOrder" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxCreateExchangeOrder" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcCreatePartialRequest" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxCreatePartialRequest" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcCreatePDARMA" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxCreatePDARMA" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcCreatePDAExchange" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxCreatePDAExchange" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcCreatePDAPartRequest" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxCreatePDAPartRequest" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcAdmin" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxAdmin" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcDeveloper" Width="10%" HorizontalAlign="Center">
                    <asp:CheckBox ID="cbxDeveloper" runat="server" Enabled="false" />
                </asp:TableCell>
                <asp:TableCell ID="tcLastPasswordUpdate" Width="10%" />
