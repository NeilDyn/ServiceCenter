<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReplacementNoInvLines.ascx.cs" Inherits="ExcelDesign.Forms.UserControls.StatisticsControls.SalesLInes.ReplacementNoInvLines" %>

<link href="../../../../css/mainpage.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="//ajax.aspnetcdn.com/ajax/jQuery/jquery-1.9.1.js"></script>

<asp:Table ID="tblReplacementNoInv" runat="server" Height="100%" Width="100%">
