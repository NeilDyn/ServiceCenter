<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReplacementOlder72HoursLines.ascx.cs" Inherits="ExcelDesign.Forms.UserControls.StatisticsControls.SalesLInes.ReplacementOlder72HoursLines" %>

<link href="../../../../css/mainpage.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="//ajax.aspnetcdn.com/ajax/jQuery/jquery-1.9.1.js"></script>

<asp:Table ID="tblReplacementOlder72Hours" runat="server" Height="100%" Width="100%">
