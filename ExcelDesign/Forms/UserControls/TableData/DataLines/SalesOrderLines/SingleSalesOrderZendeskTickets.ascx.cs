...
{
    public partial class SingleSalesOrderZendeskTickets : System.Web.UI.UserControl
    {
            ...
            foreach (Zendesk ticket in ZendeskTickets)
            {
                ...
                if (ticket.FromNAV)
                {
                    ...
                    Button updateTicket = new Button
                    {
                        ...
                        Text = "Update Ticket",
                        OnClientClick = "return ZendeskOptionsOrders(" + ticket.TicketNo + ")"
                    };
                ...
                this.SingleSalesOrderZendeskTicketsTable.Rows.Add(tr);
            }
        }
    }
}